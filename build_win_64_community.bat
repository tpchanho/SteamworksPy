...
if not exist "C:\Program Files (x86)\Microsoft Visual Studio\%1\Community\Common7\Tools\VsDevCmd.bat" (
    echo [!] Could not find your Visual Studio %1 installation!
    exit /B 5
)
call "C:\Program Files (x86)\Microsoft Visual Studio\%1\Community\Common7\Tools\VsDevCmd.bat" -host_arch=amd64 -arch=amd64
call "C:\Program Files (x86)\Microsoft Visual Studio\%1\Community\Common7\Tools\VsDevCmd.bat" -test
